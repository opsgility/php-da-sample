...
<div class="row row-offcanvas row-offcanvas-right" id="main-content-container-fluid-first-row">
    <div class="col-xs-12 col-sm-8">
        ...
        <div id="new_dicussion">
            ...
            <form action="<?php echo base_url(); ?>community/postms" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="form-horizontal discussion_form" id="new-discussion-form-upload">
                <input type="hidden" name="isAjax" value="1" />
                <input type="hidden" name="success-redirect-url" id="success-redirect-url" value="<?php echo base_url(); ?>community/" />
