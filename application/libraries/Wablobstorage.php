...
//    }
    ...
    public function createContainer($container_name, $blobsonly=false){
    ...
    public function listContainers($options = null){
         return $this->_blobRestProxy->listContainers($options = null);
    }
    
    /*
     * @return array containers name
     */
    public function getAllContainersName(){
        // all the existing containers
        $containersObj = $this->listContainers();
        $containers = $containersObj->getContainers();
        $arr = array();
        if(!empty($containers)){
           foreach($containers as $container){
               $arr[] = $container->getName();
           } 
        }
        return $arr;
    }
...
/* Location: ./application/libraries/Wablobstorage.php */